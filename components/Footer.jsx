        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 py-8 sm:py-12 text-xs sm:text-sm">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-400">
              ...
              <li><a href="#tees" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-200">Graphic Tees</a></li>
              <li><a href="#bottoms" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-200">Cargo Pants</a></li>
              <li><a href="#accessories" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-200">Accessories</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-400">
              ...
              <li><a href="#acid" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-200">Acid Wash Series</a></li>
              <li><a href="#limited" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-200">Limited Drops</a></li>
              <li><a href="#sale" className="hover:text-cyan-600 text-rose-600 dark:text-red-400/90 transition duration-200 font-medium">Clearance Sale %</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3 col-span-2 sm:col-span-1">
            ...
            <div className="flex flex-wrap gap-2.5 text-slate-600 dark:text-slate-400">
              ...
              <a href="#tiktok" className="w-9 h-9 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-cyan-500/50 hover:bg-cyan-50 dark:hover:bg-cyan-500/10 hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-300 flex items-center justify-center shadow-sm dark:shadow-none" title="TikTok" aria-label="TikTok">
              ...
              {/* Facebook SVG */}
              <a href="#facebook" className="w-9 h-9 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-cyan-500/50 hover:bg-cyan-50 dark:hover:bg-cyan-500/10 hover:text-cyan-600 dark:hover:text-cyan-400 transition duration-300 flex items-center justify-center shadow-sm dark:shadow-none" title="Facebook" aria-label="Facebook">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              
              {/* WhatsApp/Chat SVG */}
              <a href="#whatsapp" className="w-9 h-9 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-emerald-500/50 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 hover:text-emerald-600 dark:hover:text-emerald-400 transition duration-300 flex items-center justify-center shadow-sm dark:shadow-none" title="WhatsApp Chat" aria-label="WhatsApp">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
              </a>
            </div>
            <div className="text-xs text-slate-500 pt-2 leading-relaxed">
              <span className="block font-medium text-slate-700 dark:text-slate-400">Support: support@vibewear.com</span>
